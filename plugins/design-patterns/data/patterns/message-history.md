...
related:
  ...
  - message-store
relationships:
  - often-confused-with:correlation-identifier
  - companion:wire-tap
  - alternative:message-store
references:
...
- Prefer framework primitives that make Message History explicit without hiding business rules inside generic plumbing.

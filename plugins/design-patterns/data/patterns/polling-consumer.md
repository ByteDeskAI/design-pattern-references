...
related:
  ...
  - message-endpoint
relationships:
  - alternative:event-driven-consumer
...
- Prefer framework primitives that make Polling Consumer explicit without hiding business rules inside generic plumbing.

...
relationships:
  - companion:messaging-gateway
  - companion:polling-consumer
  - companion:event-driven-consumer
references:
...
- Prefer framework primitives that make Message Endpoint explicit without hiding business rules inside generic plumbing.

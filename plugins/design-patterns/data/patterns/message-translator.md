...
relationships:
  ...
  - companion:canonical-data-model
  - companion:envelope-wrapper
references:
...
- Prefer framework primitives that make Message Translator explicit without hiding business rules inside generic plumbing.

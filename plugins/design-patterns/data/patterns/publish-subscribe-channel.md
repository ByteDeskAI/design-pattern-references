...
related:
  ...
  - observer
relationships:
  - companion:event-message
  - companion:durable-subscriber
  - companion:observer
references:
...
- Prefer framework primitives that make Publish-Subscribe Channel explicit without hiding business rules inside generic plumbing.

...
related:
  ...
  - facade
relationships:
  - companion:messaging-mapper
  - companion:channel-adapter
  - companion:facade
references:
...
- Prefer framework primitives that make Messaging Gateway explicit without hiding business rules inside generic plumbing.

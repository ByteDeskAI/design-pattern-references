...
related:
  ...
  - smart-proxy
relationships:
  - companion:request-reply
  - often-confused-with:message-history
  - companion:smart-proxy
references:
...
- Prefer framework primitives that make Correlation Identifier explicit without hiding business rules inside generic plumbing.

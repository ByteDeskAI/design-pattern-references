...
relationships:
  - companion:return-address
  - companion:correlation-identifier
  - alternative:remote-procedure-invocation
references:
...
- Prefer framework primitives that make Request-Reply explicit without hiding business rules inside generic plumbing.

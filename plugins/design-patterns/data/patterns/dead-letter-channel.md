...
relationships:
  ...
  - alternative:invalid-message-channel
  - companion:idempotent-receiver
references:
...
- Prefer framework primitives that make Dead Letter Channel explicit without hiding business rules inside generic plumbing.

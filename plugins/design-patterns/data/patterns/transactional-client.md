...
related:
  ...
  - message-store
relationships:
  - alternative:guaranteed-delivery
  - often-confused-with:idempotent-receiver
...
- Prefer framework primitives that make Transactional Client explicit without hiding business rules inside generic plumbing.

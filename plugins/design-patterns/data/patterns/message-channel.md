...
related:
  ...
  - datatype-channel
relationships:
  - companion:point-to-point-channel
  - companion:publish-subscribe-channel
  - companion:datatype-channel
references:
...
- Prefer framework primitives that make Message Channel explicit without hiding business rules inside generic plumbing.

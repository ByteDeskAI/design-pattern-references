...
relationships:
  - alternative:publish-subscribe-channel
  - companion:scatter-gather
  - companion:content-based-router
references:
...
- Prefer framework primitives that make Recipient List explicit without hiding business rules inside generic plumbing.

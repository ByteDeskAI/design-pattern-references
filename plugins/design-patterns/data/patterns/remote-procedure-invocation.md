...
related:
  ...
  - service-activator
relationships:
  - alternative:request-reply
  - companion:service-activator
references:
...
- Prefer framework primitives that make Remote Procedure Invocation explicit without hiding business rules inside generic plumbing.

...
relationships:
  - companion:guaranteed-delivery
  - companion:dead-letter-channel
  - often-confused-with:transactional-client
references:
...
- Prefer framework primitives that make Idempotent Receiver explicit without hiding business rules inside generic plumbing.

...
related:
  ...
  - recipient-list
relationships:
  - often-confused-with:message-router
  - alternative:message-filter
...
- Prefer framework primitives that make Content-Based Router explicit without hiding business rules inside generic plumbing.

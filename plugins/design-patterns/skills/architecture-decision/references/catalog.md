...
Use `patterns show <slug> --json` when you need machine-readable references and related patterns. Use the Markdown files directly when you need the full body text, examples, or implementation notes.
